...
public class MessageHolders {
    public static final String DOUBLE_TAP_EVENT = "com.osmino.sova.intent.double.tap.event";
    ...
    public void bind(final ViewHolder holder, final Object item, boolean isSelected,
                     ...
                     final MessageSpanListener listener) {
        ...
        if (item instanceof IMessage) {
            ...
            ((MessageHolders.BaseMessageViewHolder) holder).setSpanOnClickListener(listener);
    ...
    public static abstract class BaseMessageViewHolder<MESSAGE extends IMessage> extends ViewHolder<MESSAGE> {
        ...
        protected MessageSpanListener spanClickListener;
        ...
        protected void configureLinksBehavior(final TextView text) {
            ...
            text.setOnTouchListener(new LinkMovementMethodOverride());
            /*text.setMovementMethod(new LinkMovementMethod() {
                @Override
                public boolean onTouchEvent(final TextView widget, final Spannable buffer, final MotionEvent event) {
                    boolean result = false;
                    if (true) { //(!MessagesListAdapter.isSelectionModeEnabled) {
        ...
        public void setSpanOnClickListener(MessageSpanListener listener) {
        ...
        private void init(View itemView) {
            ...
            gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(final MotionEvent e) {
                    context.sendBroadcast(new Intent(DOUBLE_TAP_EVENT));
                    return true;
                }
            });
    ...
    public static class IncomingTextMessageViewHolder<MESSAGE extends IMessage>
        ...
        public void onBind(MESSAGE message) {
            ...
            if (text != null) {
                String msgText = message.getText().replace("<li>", "<li>&nbsp;");
                if (VERSION.SDK_INT >= VERSION_CODES.N) {
                    text.setText(Html.fromHtml(msgText, FROM_HTML_MODE_COMPACT, null, new MessageHtmlTagHandler(spanClickListener, 0x51c05c)));
                } else {
                    text.setText(Html.fromHtml(msgText, null, new MessageHtmlTagHandler(spanClickListener, 0x51c05c)));
                }
            }
        }
